...
<body>
    ...
    <div class="main-content-base layout-top-padding">
        ...
        <!-- 送信フォーム -->
        <form method="POST" action="F-3.bookStatusChange.jsp" id="bookStatusForm" style="display: flex; flex-direction: column; flex-grow: 1;" onsubmit="return false;">
            ...
            <table class="form-table">
                ...
                <tr>
                    ...
                    <td>
                        <div style="display: flex; gap: 15px; width: 100%; align-items: center;">
                            <input type="text" class="input-field" id="search-id" name="searchId" style="width: 350px; flex-grow: 0;" placeholder="図書ID入力">
                            <button type="button" class="btn" style="padding: 5px 30px;" onclick="searchBook();">表示</button>
                        </div>
                    </td>
                </tr>
                <!-- 2行目: 書名 -->
                <tr>
                    <th>書名</th>
                    <td><input type="text" class="input-field-update" id="input-title" name="bookTitle" readonly></td>
                </tr>
                <!-- 3行目: 貸出状況 -->
                <tr>
                    <th>貸出状況</th>
                    <td><input type="text" class="input-field-update" id="input-loan-status" name="bookLoanStatus" readonly></td>
                </tr>
                <!-- 4行目: 予約状況 -->
                <tr>
                    <th>予約状況</th>
                    <td><input type="text" class="input-field-update" id="input-reserve-status" name="bookReserveStatus" readonly></td>
                </tr>
                <!-- 5行目: 本の状態 (プルダウンのみ) -->
                <tr>
                    <th>本の状態</th>
                    <td>
                        <select class="select-field" id="input-status" name="bookStatus" disabled>
    ...
    <script>
        ...
        function searchBook() {
            ...
            if (!searchId || searchId.trim() === '') {
                ...
                // 画像のダミーデータ
                inputTitle.value = '赤朽葉家の伝説';
                inputLoanStatus.value = '貸出中';
                inputReserveStatus.value = 'あり（1人）';
        ...
        function showConfirmModal() {
            document.getElementById('confirm-id').value = document.getElementById('search-id').value;
