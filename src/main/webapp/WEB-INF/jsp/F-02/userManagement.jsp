...
%>
    <header class="header">
        <div class="header-title">利用者管理画面</div>
    ...
    <main class="main-container">
        ...
        <div class="menu-panel">
            <a href="${pageContext.request.contextPath}/UsersRegist" class="menu-link" style="font-size: 40px;">利用者登録</a>
            <a href="${pageContext.request.contextPath}/UsersUpdate" class="menu-link" style="font-size: 40px;">利用者情報更新</a>
            <a href="${pageContext.request.contextPath}/UsersSearch" class="menu-link" style="font-size: 40px;">利用者情報参照</a>
        </div>
    </main>
</body>
</html>