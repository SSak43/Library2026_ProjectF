				...
				<tr>
					...
					<td><input type="text" class="input-field" id="input-title"
						...
						<button type="button" class="clear-button"
							onclick="clearInput('input-title')">クリア</button></td>
				</tr>
				<tr>
					<th>著者</th>
					<td><input type="text" class="input-field" id="input-writerName" name="writerName" required>
						<button type="button" class="clear-button"
							onclick="clearInput('input-writerName')">クリア</button></td>
				</tr>
				<tr>
					<th>出版社</th>
					<td><input type="text" class="input-field" id="input-company" name="company" required>
						<button type="button" class="clear-button" onclick="clearInput('input-company')">クリア</button></td>
				</tr>
				<tr>
					<th>分類</th>
					<td><input type="text" class="input-field" id="input-cla"
						name="cla" required>
						<button type="button" class="clear-button"
							onclick="clearInput('input-cla')">クリア</button></td>
				</tr>
			</table>
