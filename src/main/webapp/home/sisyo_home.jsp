...
<body>
    ...
    <main class="main-container">
        ...
        <div class="menu-panel">
            ...
            <a href="${pageContext.request.contextPath}/inquiryManagement" class="menu-link" style="font-size: 40px;">貸出状況照会</a>
            <a href="${pageContext.request.contextPath}/BooksMain" class="menu-link" style="font-size: 40px;">蔵書管理</a>
			<a href="${pageContext.request.contextPath}/Over" class="menu-link" style="font-size: 40px;">延滞一覧</a>
